...
public class CropvarietyController {
    ...
    public ResponseEntity<CustomResponse> create(@RequestBody JsonNode cropvarietyDetails) {
        CustomResponse response = cropvarietyService.createCropvariety(cropvarietyDetails, null);
    ...
    public ResponseEntity<CustomResponse> draft(
            ...
            @RequestBody JsonNode cropvarietyDetails) {
        lifecyclePolicy.requireEnabled(CATALOGUE_NAME);
        CustomResponse response = cropvarietyService.draftCropvariety(cropvarietyDetails, token);
        return new ResponseEntity<>(response, response.getResponseCode());
    }
    ...
    public ResponseEntity<CustomResponse> add(
            @RequestHeader(value = "Authorization", required = false) String token,
            @RequestBody JsonNode cropvarietyDetails) {
        CustomResponse response = cropvarietyService.createCropvariety(cropvarietyDetails, token);
        return new ResponseEntity<>(response, response.getResponseCode());
    }
    ...
    public ResponseEntity<CustomResponse> addById(
            @RequestHeader(value = "Authorization", required = false) String token,
            @PathVariable String id, @RequestBody JsonNode cropvarietyDetails) {
        lifecyclePolicy.requireEnabled(CATALOGUE_NAME);
        CustomResponse response = cropvarietyService.addCropvariety(id, cropvarietyDetails, token);
        return new ResponseEntity<>(response, response.getResponseCode());
    }
    ...
    public ResponseEntity<CustomResponse> approve(
        ...
        lifecyclePolicy.requireEnabled(CATALOGUE_NAME);
        CustomResponse response = cropvarietyService.approveCropvariety(request, token);
        return new ResponseEntity<>(response, response.getResponseCode());
    }
    ...
    public ResponseEntity<CustomResponse> review(
            ...
            @RequestBody LifecycleRequest request) {
        lifecyclePolicy.requireEnabled(CATALOGUE_NAME);
        CustomResponse response = cropvarietyService.reviewCropvariety(request, token);
        return new ResponseEntity<>(response, response.getResponseCode());
    }
    ...
    public ResponseEntity<CustomResponse> toggle(
        ...
        CustomResponse response = cropvarietyService.toggleStatus(id, token);
        return new ResponseEntity<>(response, response.getResponseCode());
    }
    ...
    public ResponseEntity<?> search(
        ...
        CustomResponse response = cropvarietyService.searchCropvariety(searchCriteria, token);
        return new ResponseEntity<>(response, response.getResponseCode());
    }
    ...
    public ResponseEntity<?> read(
            @RequestHeader(value = "Authorization", required = false) String token,
            @PathVariable String id) {
        CustomResponse response = cropvarietyService.read(id, token);
    ...
    public ResponseEntity<?> delete(
            @RequestHeader(value = "Authorization", required = false) String token,
            @PathVariable String id) {
        CustomResponse response = cropvarietyService.delete(id, token);
        return new ResponseEntity<>(response, HttpStatus.OK);
    }
    ...
    public ResponseEntity<CustomResponse> importData(
        ...
        CustomResponse response = cropvarietyService.importData(file, token);
        return new ResponseEntity<>(response, response.getResponseCode());
    }
