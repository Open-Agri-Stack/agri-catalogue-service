package com.catalogue.verg.fertilizer.controller;
...
public class FertilizerController {
    ...
    public ResponseEntity<CustomResponse> create(@RequestBody JsonNode fertilizerDetails) {
        CustomResponse response = fertilizerService.createFertilizer(fertilizerDetails, null);
    ...
    public ResponseEntity<CustomResponse> draft(
            ...
            @RequestBody JsonNode fertilizerDetails) {
        lifecyclePolicy.requireEnabled(CATALOGUE_NAME);
        CustomResponse response = fertilizerService.draftFertilizer(fertilizerDetails, token);
        return new ResponseEntity<>(response, response.getResponseCode());
    }
    ...
    public ResponseEntity<CustomResponse> add(
            @RequestHeader(value = "Authorization", required = false) String token,
            @RequestBody JsonNode fertilizerDetails) {
        CustomResponse response = fertilizerService.createFertilizer(fertilizerDetails, token);
        return new ResponseEntity<>(response, response.getResponseCode());
    }
    ...
    public ResponseEntity<CustomResponse> addById(
            @RequestHeader(value = "Authorization", required = false) String token,
            @PathVariable String id, @RequestBody JsonNode fertilizerDetails) {
        lifecyclePolicy.requireEnabled(CATALOGUE_NAME);
        CustomResponse response = fertilizerService.addFertilizer(id, fertilizerDetails, token);
        return new ResponseEntity<>(response, response.getResponseCode());
    }
    ...
    public ResponseEntity<CustomResponse> approve(
        ...
        lifecyclePolicy.requireEnabled(CATALOGUE_NAME);
        CustomResponse response = fertilizerService.approveFertilizer(request, token);
        return new ResponseEntity<>(response, response.getResponseCode());
    }
    ...
    public ResponseEntity<CustomResponse> review(
            ...
            @RequestBody LifecycleRequest request) {
        lifecyclePolicy.requireEnabled(CATALOGUE_NAME);
        CustomResponse response = fertilizerService.reviewFertilizer(request, token);
        return new ResponseEntity<>(response, response.getResponseCode());
    }
    ...
    public ResponseEntity<CustomResponse> toggle(
        ...
        CustomResponse response = fertilizerService.toggleStatus(id, token);
        return new ResponseEntity<>(response, response.getResponseCode());
    }
    ...
    public ResponseEntity<?> search(
        ...
        CustomResponse response = fertilizerService.searchFertilizer(searchCriteria, token);
        return new ResponseEntity<>(response, response.getResponseCode());
    }
    ...
    public ResponseEntity<?> read(
            @RequestHeader(value = "Authorization", required = false) String token,
            @PathVariable String id) {
        CustomResponse response = fertilizerService.read(id, token);
        return new ResponseEntity<>(response, HttpStatus.OK);
    }

    @PutMapping("/v1/update/{id}")
    public ResponseEntity<CustomResponse> update(@PathVariable String id, @RequestBody JsonNode fertilizerDetails) {
        CustomResponse response = fertilizerService.updateFertilizer(id, fertilizerDetails);
        return new ResponseEntity<>(response, response.getResponseCode());
    }
    ...
    public ResponseEntity<?> delete(
            @RequestHeader(value = "Authorization", required = false) String token,
            @PathVariable String id) {
        CustomResponse response = fertilizerService.delete(id, token);
        return new ResponseEntity<>(response, HttpStatus.OK);
    }
    ...
    public ResponseEntity<CustomResponse> importData(
        ...
        CustomResponse response = fertilizerService.importData(file, token);
        return new ResponseEntity<>(response, response.getResponseCode());
    }
    ...
    public ResponseEntity<CustomResponse> loadFromPrimary() {
        CustomResponse response = fertilizerService.loadFromPrimaryFertilizer();
        return new ResponseEntity<>(response, response.getResponseCode());
    }
}