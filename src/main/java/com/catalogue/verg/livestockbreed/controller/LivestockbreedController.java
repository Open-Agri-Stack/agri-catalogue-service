...
public class LivestockbreedController {
    ...
    public ResponseEntity<CustomResponse> create(@RequestBody JsonNode livestockbreedDetails) {
        CustomResponse response = livestockbreedService.createLivestockbreed(livestockbreedDetails, null);
    ...
    public ResponseEntity<CustomResponse> draft(
            ...
            @RequestBody JsonNode livestockbreedDetails) {
        lifecyclePolicy.requireEnabled(CATALOGUE_NAME);
        CustomResponse response = livestockbreedService.draftLivestockbreed(livestockbreedDetails, token);
        return new ResponseEntity<>(response, response.getResponseCode());
    }
    ...
    public ResponseEntity<CustomResponse> add(
            @RequestHeader(value = "Authorization", required = false) String token,
            @RequestBody JsonNode livestockbreedDetails) {
        CustomResponse response = livestockbreedService.createLivestockbreed(livestockbreedDetails, token);
        return new ResponseEntity<>(response, response.getResponseCode());
    }
    ...
    public ResponseEntity<CustomResponse> addById(
            @RequestHeader(value = "Authorization", required = false) String token,
            @PathVariable String id, @RequestBody JsonNode livestockbreedDetails) {
        lifecyclePolicy.requireEnabled(CATALOGUE_NAME);
        CustomResponse response = livestockbreedService.addLivestockbreed(id, livestockbreedDetails, token);
        return new ResponseEntity<>(response, response.getResponseCode());
    }
    ...
    public ResponseEntity<CustomResponse> approve(
        ...
        lifecyclePolicy.requireEnabled(CATALOGUE_NAME);
        CustomResponse response = livestockbreedService.approveLivestockbreed(request, token);
        return new ResponseEntity<>(response, response.getResponseCode());
    }
    ...
    public ResponseEntity<CustomResponse> review(
            ...
            @RequestBody LifecycleRequest request) {
        lifecyclePolicy.requireEnabled(CATALOGUE_NAME);
        CustomResponse response = livestockbreedService.reviewLivestockbreed(request, token);
        return new ResponseEntity<>(response, response.getResponseCode());
    }
    ...
    public ResponseEntity<CustomResponse> toggle(
        ...
        CustomResponse response = livestockbreedService.toggleStatus(id, token);
        return new ResponseEntity<>(response, response.getResponseCode());
    }
    ...
    public ResponseEntity<?> search(
        ...
        CustomResponse response = livestockbreedService.searchLivestockbreed(searchCriteria, token);
        return new ResponseEntity<>(response, response.getResponseCode());
    }
    ...
    public ResponseEntity<?> read(
            @RequestHeader(value = "Authorization", required = false) String token,
            @PathVariable String id) {
        CustomResponse response = livestockbreedService.read(id, token);
        return new ResponseEntity<>(response, HttpStatus.OK);
    }

    @PutMapping("/v1/update/{id}")
    public ResponseEntity<CustomResponse> update(@PathVariable String id, @RequestBody JsonNode livestockbreedDetails) {
        CustomResponse response = livestockbreedService.updateLivestockbreed(id, livestockbreedDetails);
        return new ResponseEntity<>(response, response.getResponseCode());
    }
    ...
    public ResponseEntity<?> delete(
            @RequestHeader(value = "Authorization", required = false) String token,
            @PathVariable String id) {
        CustomResponse response = livestockbreedService.delete(id, token);
        return new ResponseEntity<>(response, HttpStatus.OK);
    }
    ...
    public ResponseEntity<CustomResponse> importData(
        ...
        CustomResponse response = livestockbreedService.importData(file, token);
        return new ResponseEntity<>(response, response.getResponseCode());
    }
    ...
    public ResponseEntity<CustomResponse> loadFromPrimary() {
        CustomResponse response = livestockbreedService.loadFromPrimaryLivestockbreed();
        return new ResponseEntity<>(response, response.getResponseCode());
    }
}