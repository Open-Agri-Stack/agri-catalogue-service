package com.catalogue.verg.livestockcategory.controller;
...
@RestController
@RequestMapping("/livestockcategory")
public class LivestockcategoryController {
    ...
    public ResponseEntity<CustomResponse> update(@PathVariable String id, @RequestBody JsonNode livestockcategoryDetails) {
        CustomResponse response = livestockcategoryService.updateLivestockcategory(id, livestockcategoryDetails);
        return new ResponseEntity<>(response, response.getResponseCode());
    }
    ...
    public ResponseEntity<CustomResponse> loadFromPrimary() {
        CustomResponse response = livestockcategoryService.loadFromPrimaryLivestockcategory();
        return new ResponseEntity<>(response, response.getResponseCode());
    }
}